...
def list_kb_document(*, limit: int=50, offset: int=0, visibility: str | None = None) -> list[dict[str, Any]]:
    ...
    sql += ' ORDER BY updated_at DESC LIMIT %s OFFSET %s' # 数据库无序，因此需要手动排序并限制检索输出数量，防止将所有内容丢出
